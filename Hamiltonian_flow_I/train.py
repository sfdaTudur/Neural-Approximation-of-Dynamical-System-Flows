...
def main():
    ...
    parser.add_argument("--data", type=str, default=r"D:\flow_datasets\Ham_FlowI_train_data.pt", help="path to dataset .pt file")
    ...
    parser.add_argument("--save", type=str, default=r"D:\flow_datasets/checkpoints/Ham_FlowI_weights.pth", help="where to save the model state_dict")
